            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden h-48">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-cyberpunk-darker-bg via-transparent to-transparent opacity-60"></div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.slice(0, 3).map((tech, techIndex) => (
                      <span 
                        key={techIndex}
                        className="px-2 py-1 bg-cyberpunk-neon-purple/20 text-cyberpunk-neon-purple text-xs font-mono rounded-full border border-cyberpunk-neon-purple/30"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex space-x-3 pt-2">
                    {project.githubLink && (
                      <a
                        ...
                        className="flex items-center space-x-2 px-3 py-2 bg-cyberpunk-neon-purple/20 text-cyberpunk-neon-purple border border-cyberpunk-neon-purple/30 rounded-lg hover:bg-cyberpunk-neon-purple/30 transition-all duration-300 text-sm"
                      >
                    ...
                    {project.liveLink && (
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="flex items-center space-x-2 px-3 py-2 bg-cyberpunk-neon-blue/20 text-cyberpunk-neon-blue border border-cyberpunk-neon-blue/30 rounded-lg hover:bg-cyberpunk-neon-blue/30 transition-all duration-300 text-sm"
                      >
